...
namespace Spoleto.Delivery.Providers.Cdek
{
    ...
    public enum AdditionalServiceType
    {
        ...
        /// <summary>
        /// СМС-уведомление о прибытии заказа
        /// </summary>
        /// <remarks>
        /// СМС-уведомление о прибытии заказа для получателя. Доступна для заказов с типом "ИМ".
        /// </remarks>
        [Description("СМС-уведомление о прибытии заказа")]
        SMS_NOTIFICATIONS_FOR_THE_RECIPIENT,

        /// <summary>
        /// СМС-уведомление об окончании срока хранения
        /// </summary>
        /// <remarks>
        /// СМС-уведомление об окончании срока хранения для получателя. Доступна для заказов с типом "ИМ".
        /// </remarks>
        [Description("СМС-уведомление об окончании срока хранения")]
        SMS_NOTIFICATIONS_FOR_EXPIRATION_DATE,

        /// <summary>
        /// Экспортное таможенное оформление (с документами)
        /// </summary>
        /// <remarks>
        /// Экспортное таможенное оформление (с пакетом документов)
        /// </remarks>
        [Description("Экспортное таможенное оформление (с документами)")]
        EXP_REGIST_WITH_DOC,

        /// <summary>
        /// Экспортное таможенное оформление (без документов)
        /// </summary>
        /// <remarks>
        /// Экспортное таможенное оформление (без пакета документов)
        /// </remarks>
        [Description("Экспортное таможенное оформление (без документов)")]
        EXP_REGIST_WITHOUT_DOC,
        ...
        /// Экспортное таможенное оформление
        /// </remarks>
        [Description("Экспортное таможенное оформление")]
        EXP_REGIST,

        /// <summary>
        /// ТО для последней мили B2B 200-
        /// </summary>
        /// <remarks>
        /// ТО для последней мили B2B 200-
        /// </remarks>
        [Description("ТО для последней мили B2B 200-")]
        CUSTOM_CLEARENCE_FOR_LAST_MILE_B2B_200,
        ...
        /// ТО для последней мили
        /// </remarks>
        [Description("ТО для последней мили")]
        CUSTOMS_CLEARANCE_FOR_THE_LAST_MILE,
        ...
        /// </remarks>
        [Description("ТО для последней мили B2B 200+")]
        CUSTOM_CLEARENCE_FOR_LAST_MILE_B2B_200469,

        /// <summary>
        /// Таможенное оформление B2B 1000+ экспорт
        /// </summary>
        /// <remarks>
        /// Таможенное оформление B2B 1000+ экспорт
        /// </remarks>
        [Description("Таможенное оформление B2B 1000+ экспорт")]
        CUSTOM_CLEARENCE_FOR_B2B_1000_EXPORT,

        /// <summary>
        /// Таможенное оформление B2B 200+ импорт
        /// </summary>
        /// <remarks>
        /// Таможенное оформление B2B 200+ импорт
        /// </remarks>
        [Description("Таможенное оформление B2B 200+ импорт")]
        CUSTOM_CLEARENCE_FOR_B2B_200_IMPORT,

        /// <summary>
        /// Самостоятельное таможенное оформление B2B экспорт
        /// </summary>
        /// <remarks>
        /// Самостоятельное таможенное оформление B2B экспорт
        /// </remarks>
        [Description("Самостоятельное таможенное оформление B2B экспорт")]
        SELF_CLEARING_CUSTOMS_FOR_B2B_EXPORT,
        ...
        /// <summary>
        /// Пакет курьерский «Лайт» А2 (белый)
        /// </summary>
        /// <remarks>
        /// Курьерский пакет без дизайна (белый) из влагонепроницаемого многослойного полиэтилена.
        /// </remarks>
        [Description("Пакет курьерский «Лайт» А2 (белый)")]
        PACKAGE_A_2_LIGHT_EXPRESS,

        /// <summary>
        /// Пакет курьерский «Лайт» А3 (белый)
        /// </summary>
        /// <remarks>
        /// Курьерский пакет без дизайна (белый) из влагонепроницаемого многослойного полиэтилена.
        ///</remarks>
        [Description("Пакет курьерский «Лайт» А3 (белый)")]
        PACKAGE_A_3_LIGHT_EXPRESS,

        /// <summary>
        /// Пакет курьерский «Лайт» А4 (белый)
        /// </summary>
        /// <remarks>
        /// Курьерский пакет без дизайна (белый) из влагонепроницаемого многослойного полиэтилена.
        /// </remarks>
        [Description("Пакет курьерский «Лайт» А4 (белый)")]
        PACKAGE_A_4_LIGHT_EXPRESS,

        /// <summary>
        /// Пакет курьерский «Лайт» А5 (белый)
        /// </summary>
        /// <remarks>
        /// Курьерский пакет без дизайна (белый) из влагонепроницаемого многослойного полиэтилена.
        /// </remarks>
        ...
        /// <summary>
        /// Внутренняя обрешётка "Коробка XL"
        /// </summary>
        /// <remarks>
        /// Вставка защитная (амортизационный картонный каркас), вкладывается внутрь коробки. Каркас сконструирован для конкретной коробки "Коробка (18 кг 60х35х30см)".
        /// Данную доп. услугу необходимо передавать только в паре с соответствующей коробкой CARTON_BOX_XL_18_KILOS
        /// </remarks>
        [Description("Внутренняя обрешётка \"Коробка XL\"")]
        XL_BOX_INNER_CRATE,

        //TODO: change to JsonValue to use numbers in the beginning
        
        ///// <summary>
        ///// Внутренняя обрешётка "Коробка Вес до 20кг"
        ///// </summary>
        ///// <remarks>
        ///// </remarks>
        //[Description("Внутренняя обрешётка \"Коробка Вес до 20кг\"")]
        //20_KG_BOX_INNER_CRATE,

        ///// <summary>
        ///// Внутренняя обрешётка \"Коробка Вес до 30кг\"
        ///// </summary>
        ///// <remarks>
        ///// Вставка защитная (амортизационный картонный каркас), вкладывается внутрь коробки. Каркас сконструирован для конкретной коробки "Коробка (30 кг 69х39х42 см)".
        ///// Данную доп. услугу необходимо передавать только в паре с соответствующей коробкой CARTON_BOX_30KG
        ///// </remarks>
        //[Description("Внутренняя обрешётка \"Коробка Вес до 30кг\"")]
        //30_KG_BOX_INNER_CRATE,
        ...
        /// </summary>
        /// <remarks>
        /// Таможенное оформление в рамках сервиса международной доставки грузов В2В.
        /// Начисляется автоматически при создании международных заказов с тарифами "Business Standard"/"Business Express".
        /// </remarks>
        [Description("Таможенное оформление")]
        CUSTOMS_CLEARANCE,

        /// <summary>
        /// Коробка (18 кг 60х35х30см)
        /// </summary>
        /// <remarks>
        /// Коробка из трехслойного гофрокартона размером 600x350x300 мм. Максимальная вместимость - 18 кг.
        /// Доступные режимы: склад-дверь, склад-склад, склад-постамат
        /// </remarks>
        [Description("Коробка (18 кг 60х35х30см)")]
